...
var config = {
	...
	exportUrl: 'dict-schema-export.do'
};
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="dict-typeForm" method="post" action="dict-schema-list.do" class="form-inline">
...
<form id="dict-typeGridForm" name="dict-typeGridForm" method='post' action="dict-schema-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
