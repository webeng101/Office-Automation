...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="pull-right ctrl">
	  <a class="btn btn-default btn-xs"><i id="org-companySearchIcon" class="glyphicon glyphicon-chevron-up"></i></a>
    </div>
  </div>
  <div class="panel-body">

		  <form name="org-companyForm" method="post" action="org-company-list.do" class="form-inline">
		    <label for="org-company_name"><spring:message code='org-company.org-company.list.search.name' text='名称'/>:</label>
		    <input type="text" id="org-company_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}" class="form-control">
			<button class="btn btn-default a-search" onclick="document.org-companyForm.submit()">查询</button>&nbsp;
		  </form>
...
<form id="org-companyGridForm" name="org-companyGridForm" method='post' action="org-company-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
