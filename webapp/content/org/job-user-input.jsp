...
<form id="orgForm" method="post" action="job-user-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="org_orgname">人员</label>
	<div class="col-sm-5">
	  <input id="org_orgname" type="text" name="userRef" value="${model.userRef}" size="40" class="form-control required" minlength="1" maxlength="50">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-md-1" for="job_level">职位</label>
	<div class="col-sm-5">
