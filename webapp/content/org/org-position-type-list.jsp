...
var config = {
	...
	exportUrl: 'org-position-type-export.do'
};
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgSearch" class="content content-inner">
		  ...
		  <form name="orgForm" method="post" action="org-position-type-list.do" class="form-inline">
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title">岗位类型列表</h4>
		</header>
		<div class="content">

<form id="orgGridForm" name="orgGridForm" method='post' action="org-position-type-remove.do" class="m-form-blank">
  <table id="orgGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.name}</td>
        <td>
          <a href="org-position-type-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
