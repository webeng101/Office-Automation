...
$(function() {
  ...
  <body>
    <%@include file="/header/leave-info.jsp"%>

    <div class="row-fluid">
	  <%@include file="/menu/leave-info.jsp"%>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="leave-infoForm" method="post" action="leave-info-list.do" class="form-inline">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='leave-info-input.do'">新建</button>
  ...
  <table id="leave-infoGrid" class="table table-hover">
    <thead>
      <tr>
        ...
        <th class="sorting" name="id"><spring:message code="leave-info.leave-info.list.id" text="编号"/></th>
        <th class="sorting" name="name"><spring:message code="leave-info.leave-info.list.name" text="名称"/></th>
        <th width="80">&nbsp;</th>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.name}</td>
        <td>
          <a href="leave-info-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
