...
var config = {
	...
	exportUrl: 'attendance-rule-export.do'
};
...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="pull-right ctrl">
	  <a class="btn btn-default btn-xs"><i id="attendance-infoSearchIcon" class="glyphicon glyphicon-chevron-up"></i></a>
    </div>
  </div>
  <div class="panel-body">

		  <form name="attendance-infoForm" method="post" action="attendance-rule-list.do" class="form-inline">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='attendance-rule-input.do'">新建</button>
...
<form id="attendance-infoGridForm" name="attendance-infoGridForm" method='post' action="attendance-rule-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
  ...
  <table id="attendance-infoGrid" class="table table-hover">
    <thead>
      <tr>
        ...
        <th class="sorting" name="startHour">上班时间</th>
        <th class="sorting" name="endHour">下班时间</th>
        <th>&nbsp;</th>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="attendance-rule-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
