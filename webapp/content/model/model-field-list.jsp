...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="pull-right ctrl">
	  <a class="btn btn-default btn-xs"><i id="model-fieldSearchIcon" class="glyphicon glyphicon-chevron-up"></i></a>
    </div>
  </div>
  <div class="panel-body">
		  ...
		  <form name="model-fieldForm" method="post" action="model-field-list.do" class="form-inline">
		    ...
		    <input type="text" id="model-field_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}" class="form-control">
			<button class="btn btn-default a-search" onclick="document.model-fieldForm.submit()">查询</button>&nbsp;
		  </form>
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='model-field-input.do'">新建</button>
...
<form id="model-fieldGridForm" name="model-fieldGridForm" method='post' action="model-field-remove.do" class="m-form-blank">
  ...
  <table id="model-fieldGrid" class="table table-hover">
    <thead>
      <tr>
