...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form name="pimRemindForm" method="post" action="pim-remind-list.do" class="form-inline">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='pim-remind-input.do'">新建</button>
...
<form id="pimRemindGridForm" name="pimRemindGridForm" method='post' action="pim-remind-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  列表
		</div>
  <table id="pimRemindGrid" class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="pim-remind-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
