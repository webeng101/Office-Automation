...
<form id="reportRemindForm" method="post" action="report-subject-save.do" class="form-horizontal">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
	  <input id="reportInfo_department" type="text" name="description" value="${model.description}" class="form-control required" minlength="2" maxlength="50">
    </div>
  </div>
  <div class="form-group">
