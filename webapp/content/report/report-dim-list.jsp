...
var config = {
	...
	exportUrl: 'report-dim-export.do'
};
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form name="reportRemindForm" method="post" action="report-dim-list.do" class="form-inline">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='report-dim-input.do'">新建</button>
...
<form id="reportRemindGridForm" name="reportRemindGridForm" method='post' action="report-dim-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  列表
		</div>
  <table id="reportRemindGrid" class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="report-dim-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
