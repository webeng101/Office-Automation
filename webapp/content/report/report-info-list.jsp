...
var config = {
	...
	exportUrl: 'report-info-export.do'
};
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form name="reportRemindForm" method="post" action="report-info-list.do" class="form-inline">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='report-info-input.do'">新建</button>
...
<form id="reportRemindGridForm" name="reportRemindGridForm" method='post' action="report-info-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  列表
		</div>
  <table id="reportRemindGrid" class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.reportQuery.name}</td>
        <td>
          <a href="report-info-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
