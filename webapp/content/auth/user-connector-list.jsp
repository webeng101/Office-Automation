...
var config = {
    ...
    asc: ${page.asc},
    params: {
        'filter_LIKES_AI.username': '${param['filter_LIKES_AI.username']}'
    },
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="user-connectorForm" method="post" action="user-connector-list.do" class="form-inline">
		    ...
		    <input type="text" id="user-connector_username" name="filter_LIKES_AI.username" value="${param['filter_LIKES_AI.username']}" class="form-control">
