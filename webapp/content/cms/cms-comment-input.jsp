...
<form id="cmsCommentForm" method="post" action="cms-comment-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="cms-comment_cmsCommentname">标题</label>
	<div class="col-sm-5">
	  <input id="cms-comment_cmsCommentname" type="text" name="title" value="${model.title}" size="40" class="form-control required" minlength="2" maxlength="50">
    </div>
  </div>
  <div class="form-group">
