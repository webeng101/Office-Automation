...
<form id="demoForm" method="post" action="whitelist-app-save.do" class="form-horizontal">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
	  <input id="demo_name" type="text" name="name" value="${model.name}" size="40" class="form-control required" minlength="2" maxlength="10">
    </div>
  </div>
  <div class="form-group">
